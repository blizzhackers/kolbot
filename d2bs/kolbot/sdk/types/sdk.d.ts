	...
	namespace sdk {
		...
		export namespace monsters {
			namespace preset {
				...
				const Bonebreak: 705;
				const Griswold: 709;
				const PitspawnFouldog: 711;
				const FlamespiketheCrawler: 712;
				const BloodwitchtheWild: 715;
				const Fangskin: 716;
				const Leatherarm: 718;
				const ColdwormtheBurrower: 719;
				const AncientKaatheSoulless: 723;
				const WebMagetheBurning: 725;
				const WitchDoctorEndugu: 726;
				const Stormtree: 727;
				const SarinatheBattlemaid: 728;
				const IcehawkRiftwing: 729;
				const IsmailVilehand: 730;
				const GelebFlamefinger: 731;
				const BremmSparkfist: 732;
				const ToorcIcefist: 733;
				const WyandVoidfinger: 734;
				const MafferDragonhand: 735;
				const WingedDeath: 736;
				const ListertheTormentor: 737;
				const Taintbreeder: 738;
				const RiftwraiththeCannibal: 739;
				const InfectorofSouls: 740;
				const LordDeSeis: 741;
				const GrandVizierofChaos: 742;
				const Hephasto: 745;
				const SiegeBoss: 746;
				const AxeDweller: 750;
				const BonesawBreaker: 751;
				const EldritchtheRectifier: 753;
				const ThreshSocket: 755;
				const Pindleskin: 756;
				const SnapchipShatter: 757;
				const AnodizedElite: 758;
				const VinvearMolech: 759;
				const MagmaTorquer: 761;
				const BlazeRipper: 762;
				const Frozenstein: 763;
				const Nihlathak: 764;
				const Wave1Spawn: 765;
				const Wave2Spawn: 766;
				const Wave3Spawn: 767;
				const Wave4Spawn: 768;
				const Wave5Spawn: 769;
		...
		export namespace items {
			...
			const ArchonStaff: 263;
			const SpiderBow: 264;
			const BladeBow: 265;
			const ShadowBow: 266;
			const GreatBow: 267;
			const DiamondBow: 268;
			const CrusaderBow: 269;
			const WardBow: 270;
			const HydraBow: 271;
			const PelletBow: 272;
			const GorgonCrossbow: 273;
			const ColossusCrossbow: 274;
			const DemonCrossbow: 275;
			const EagleOrb: 276;
			const SacredGlobe: 277;
			const SmokedSphere: 278;
			const ClaspedOrb: 279;
			const JaredsStone: 280;
			const StagBow: 281;
			const ReflexBow: 282;
			const MaidenSpear: 283;
			const MaidenPike: 284;
			const MaidenJavelin: 285;
			const GlowingOrb: 286;
			const CrystallineGlobe: 287;
			const CloudySphere: 288;
			const SparklingBall: 289;
			const SwirlingCrystal: 290;
			const AshwoodBow: 291;
			const CeremonialBow: 292;
			const CeremonialSpear: 293;
			const CeremonialPike: 294;
			const CeremonialJavelin: 295;
			const HeavenlyStone: 296;
			const EldritchOrb: 297;
			const DemonHeart: 298;
			const VortexOrb: 299;
			const DimensionalShard: 300;
			const MatriarchalBow: 301;
			const GrandMatronBow: 302;
			const MatriarchalSpear: 303;
			const MatriarchalPike: 304;
			const MatriarchalJavelin: 305;
			const Cap: 306;
			const SkullCap: 307;
			const Helm: 308;
			const FullHelm: 309;
			...
			const Crown: 311;
			const Mask: 312;
			const QuiltedArmor: 313;
			const LeatherArmor: 314;
			const HardLeatherArmor: 315;
			const StuddedLeather: 316;
			const RingMail: 317;
			const ScaleMail: 318;
			const ChainMail: 319;
			const BreastPlate: 320;
			const SplintMail: 321;
			const PlateMail: 322;
			const FieldPlate: 323;
			const GothicPlate: 324;
			const FullPlateMail: 325;
			const AncientArmor: 326;
			const LightPlate: 327;
			const Buckler: 328;
			const SmallShield: 329;
			const LargeShield: 330;
			const KiteShield: 331;
			const TowerShield: 332;
			const GothicShield: 333;
			const LeatherGloves: 334;
			const HeavyGloves: 335;
			const ChainGloves: 336;
			const LightGauntlets: 337;
			const Gauntlets: 338;
			const Boots: 339;
			const HeavyBoots: 340;
			const ChainBoots: 341;
			const LightPlatedBoots: 342;
			const Greaves: 343;
			const Sash: 344;
			const LightBelt: 345;
			const Belt: 346;
			const HeavyBelt: 347;
			const PlatedBelt: 348;
			const BoneHelm: 349;
			const BoneShield: 350;
			const SpikedShield: 351;
			const WarHat: 352;
			const Sallet: 353;
			const Casque: 354;
			const Basinet: 355;
			const WingedHelm: 356;
			const GrandCrown: 357;
			const DeathMask: 358;
			const GhostArmor: 359;
			const SerpentskinArmor: 360;
			const DemonhideArmor: 361;
			const TrellisedArmor: 362;
			const LinkedMail: 363;
			const TigulatedMail: 364;
			const MeshArmor: 365;
			const Cuirass: 366;
			const RussetArmor: 367;
			const TemplarCoat: 368;
			const SharktoothArmor: 369;
			const EmbossedPlate: 370;
			const ChaosArmor: 371;
			const OrnatePlate: 372;
			const MagePlate: 373;
			const Defender: 374;
			const RoundShield: 375;
			const Scutum: 376;
			const DragonShield: 377;
			const Pavise: 378;
			const AncientShield: 379;
			const DemonhideGloves: 380;
			const SharkskinGloves: 381;
			const HeavyBracers: 382;
			const BattleGauntlets: 383;
			const WarGauntlets: 384;
			const DemonhideBoots: 385;
			const SharkskinBoots: 386;
			const MeshBoots: 387;
			const BattleBoots: 388;
			const WarBoots: 389;
			const DemonhideSash: 390;
			const SharkskinBelt: 391;
			const MeshBelt: 392;
			const BattleBelt: 393;
			const WarBelt: 394;
			const GrimHelm: 395;
			const GrimShield: 396;
			const BarbedShield: 397;
			const WolfHead: 398;
			const HawkHelm: 399;
			const Antlers: 400;
			const FalconMask: 401;
			const SpiritMask: 402;
			const JawboneCap: 403;
			const FangedHelm: 404;
			const HornedHelm: 405;
			const AssaultHelmet: 406;
			const AvengerGuard: 407;
			const Targe: 408;
			const Rondache: 409;
			const HeraldicShield: 410;
			const AerinShield: 411;
			const CrownShield: 412;
			const PreservedHead: 413;
			const ZombieHead: 414;
			const UnravellerHead: 415;
			const GargoyleHead: 416;
			const DemonHead: 417;
			const Circlet: 418;
			const Coronet: 419;
			const Tiara: 420;
			const Diadem: 421;
			const Shako: 422;
			const Hydraskull: 423;
			const Armet: 424;
			const GiantConch: 425;
			const SpiredHelm: 426;
			const Corona: 427;
			const Demonhead: 428;
			const DuskShroud: 429;
			const Wyrmhide: 430;
			const ScarabHusk: 431;
			const WireFleece: 432;
			const DiamondMail: 433;
			const LoricatedMail: 434;
			const Boneweave: 435;
			const GreatHauberk: 436;
			const BalrogSkin: 437;
			const HellforgePlate: 438;
			const KrakenShell: 439;
			const LacqueredPlate: 440;
			const ShadowPlate: 441;
			const SacredArmor: 442;
			const ArchonPlate: 443;
			const Heater: 444;
			const Luna: 445;
			const Hyperion: 446;
			const Monarch: 447;
			const Aegis: 448;
			const Ward: 449;
			const BrambleMitts: 450;
			const VampireboneGloves: 451;
			const Vambraces: 452;
			const CrusaderGauntlets: 453;
			const OgreGauntlets: 454;
			const WyrmhideBoots: 455;
			const ScarabshellBoots: 456;
			const BoneweaveBoots: 457;
			const MirroredBoots: 458;
			const MyrmidonGreaves: 459;
			const SpiderwebSash: 460;
			const VampirefangBelt: 461;
			const MithrilCoil: 462;
			const TrollBelt: 463;
			const ColossusGirdle: 464;
			const BoneVisage: 465;
			const TrollNest: 466;
			const BladeBarrier: 467;
			const AlphaHelm: 468;
			const GriffonHeaddress: 469;
			const HuntersGuise: 470;
			const SacredFeathers: 471;
			const TotemicMask: 472;
			const JawboneVisor: 473;
			const LionHelm: 474;
			const RageMask: 475;
			const SavageHelmet: 476;
			const SlayerGuard: 477;
			const AkaranTarge: 478;
			const AkaranRondache: 479;
			const ProtectorShield: 480;
			const GildedShield: 481;
			const RoyalShield: 482;
			const MummifiedTrophy: 483;
			const FetishTrophy: 484;
			const SextonTrophy: 485;
			const CantorTrophy: 486;
			const HierophantTrophy: 487;
			const BloodSpirit: 488;
			const SunSpirit: 489;
			const EarthSpirit: 490;
			const SkySpirit: 491;
			const DreamSpirit: 492;
			const CarnageHelm: 493;
			const FuryVisor: 494;
			const DestroyerHelm: 495;
			const ConquerorCrown: 496;
			const GuardianCrown: 497;
			const SacredTarge: 498;
			const SacredRondache: 499;
			const KurastShield: 500;
			const ZakarumShield: 501;
			const VortexShield: 502;
			const MinionSkull: 503;
			const HellspawnSkull: 504;
			const OverseerSkull: 505;
			const SuccubusSkull: 506;
			const BloodlordSkull: 507;
			const Amulet: 520;
			const Ring: 522;
			const Arrows: 526;
			const Bolts: 528;
			...
			const TomeofTownPortal: 518;
			const TomeofIdentify: 519;
			const ScrollofTownPortal: 529;
			const ScrollofIdentify: 530;
			const RancidGasPotion: 80;
			const OilPotion: 81;
			const ChokingGasPotion: 82;
			const ExplodingPotion: 83;
			const StranglingGasPotion: 84;
			const FulminatingPotion: 85;
			const StaminaPotion: 513;
			const AntidotePotion: 514;
			const RejuvenationPotion: 515;
			const FullRejuvenationPotion: 516;
			const ThawingPotion: 517;
			const MinorHealingPotion: 587;
			const LightHealingPotion: 588;
			const HealingPotion: 589;
			const GreaterHealingPotion: 590;
			const SuperHealingPotion: 591;
			const MinorManaPotion: 592;
			const LightManaPotion: 593;
			const ManaPotion: 594;
			const GreaterManaPotion: 595;
			const SuperManaPotion: 596;
			const Gold: 523;
			// Charms
			const SmallCharm: 603;
			const LargeCharm: 604;
			const GrandCharm: 605;
