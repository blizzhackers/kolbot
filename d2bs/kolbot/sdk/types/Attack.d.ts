...
declare global {
	...
	namespace Attack {
		...
		function canTeleStomp(unit: Unit): boolean;
		...
		function deploy(unit: any, distance: any, spread: any, range: any, ...args: any[]): boolean;
		...
		function skipCheck(unit: Unit): boolean;
		function getSkillElement(skillId: number): false | "physical" | "fire" | "lightning" | "magic" | "cold" | "poison" | "holybolt" | "none";
		function getResist(unit: Unit, type: "physical" | "fire" | "lightning" | "magic" | "cold" | "poison" | "holybolt" | "none"): boolean;
		function getLowerResistPercent(): number;
		function getConvictionPercent(): number;
		function checkResist(unit: any, val: any, maxres?: number): boolean;
		function canAttack(unit: any): boolean;
		function usingBow(): false | "bow" | "crossbow";
		function getIntoPosition(unit: any, distance: any, coll: any, walk: any): boolean;
		function getNearestMonster(givenSettings?: {}): any;
		function checkCorpse(unit: any): boolean;
		function checkNearCorpses(unit: any, range?: number): any;
		function whirlwind(unit: any): boolean;
	}
}
