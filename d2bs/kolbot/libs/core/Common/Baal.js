...
(function (module) {
  module.exports = new function () {
    ...
    this.clearThrone = function () {
      ...
      const nodes = [
        new PathNode(15097, 5054),
        new PathNode(15079, 5014),
        new PathNode(15085, 5053),
        new PathNode(15085, 5040),
        new PathNode(15098, 5040),
        new PathNode(15099, 5022),
        new PathNode(15086, 5024),
        new PathNode(15079, 5014)
      ].sort(Sort.units);
      ...
      while (nodes.length > 0) {
        ...
        if (node.distance < 35 && node.mobCount({ range: 30 }) === 0) {
          continue;
        }
