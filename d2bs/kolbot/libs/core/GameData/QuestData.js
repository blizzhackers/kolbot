...
(function (module) {
	...
	const QuestData = (function () {
		...
		[
			sdk.quest.id.SpokeToWarriv, sdk.quest.id.AbleToGotoActII, sdk.quest.id.SpokeToJerhyn, sdk.quest.id.AbleToGotoActIII,
			sdk.quest.id.SpokeToHratli, sdk.quest.id.AbleToGotoActIV, sdk.quest.id.SpokeToTyrael, sdk.quest.id.AbleToGotoActV,
		...
		[
			[
				sdk.quest.id.SpokeToWarriv, sdk.quest.id.DenofEvil, sdk.quest.id.SistersBurialGrounds, sdk.quest.id.ToolsoftheTrade,
				sdk.quest.id.TheSearchForCain, sdk.quest.id.ForgottenTower, sdk.quest.id.SistersToTheSlaughter, sdk.quest.id.Respec
			],
			[
				sdk.quest.id.AbleToGotoActII, sdk.quest.id.SpokeToJerhyn, sdk.quest.id.RadamentsLair, sdk.quest.id.TheHoradricStaff,
				sdk.quest.id.TheTaintedSun, sdk.quest.id.TheSummoner, sdk.quest.id.TheArcaneSanctuary, sdk.quest.id.TheSevenTombs
			],
			[
			...
			[
				sdk.quest.id.AbleToGotoActV, sdk.quest.id.SiegeOnHarrogath, sdk.quest.id.RescueonMountArreat, sdk.quest.id.PrisonofIce,
