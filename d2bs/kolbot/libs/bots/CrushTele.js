	...
	while (true) {
		if (go) {
			...
			case 57:
				...
				Pather.moveToPreset(me.area, sdk.unittype.Object, 354);
				break;
			case 43:
				Pather.moveToExit([62, 63, 64], true);
				Pather.moveToPreset(me.area, sdk.unittype.Object, 356);
				break;
			case 44:
			...
			case 46:
				...
				break;
			case 74:
				Pather.moveToPreset(me.area, sdk.unittype.Object, 357, 0, 0, false, true);
				break;
			case 101:
