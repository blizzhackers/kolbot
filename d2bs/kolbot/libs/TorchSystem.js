...
const TorchSystem = {
	...
	waitForKeys: function () {
		...
		while (true) {
			...
			// Get the number keys
			tkeys = me.findItems("pk1", sdk.itemmode.inStorage).length || 0;
			hkeys = me.findItems("pk2", sdk.itemmode.inStorage).length || 0;
			dkeys = me.findItems("pk3", sdk.itemmode.inStorage).length || 0;
